...
execute as @a[hasitem={item=fables_avatars:mining_helmet,location=slot.armor.head}] at @s run effect @s haste 15 3 true
execute as @a[hasitem={item=fables_avatars:mining_helmet,location=slot.armor.head}] at @s run fill  ~-10 ~-10 ~-10 ~10 ~10 ~10 air replace light_block_15
