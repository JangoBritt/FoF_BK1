/execute as @a[hasitem={item=fables_avatars:bunny_mask_item,location=slot.armor.head}] at @s run effect @s jump_boost 15 2 true
/execute as @a[hasitem={item=fables_avatars:big_bunny_ears_item,location=slot.armor.head}] at @s run effect @s jump_boost 15 2 true
/execute as @a[hasitem={item=fables_avatars:bunny_ears_item,location=slot.armor.head}] at @s run effect @s jump_boost 15 2 true
