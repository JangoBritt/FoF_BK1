...
if ($rootfolder -eq "members") {
    ...
    'give @s[name="' + $Gamertag + '"] fables_avatars:' + $newunique + '_head_item' | out-file -Encoding ASCII $ScriptPath\$BPFolder\functions\players.mcfunction -Append
}
...
'' | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\EN_US.lang -Append


if ($rootfolder -eq "members" -or $rootfolder -eq "specials" -or $rootfolder -eq "uniques") {

    'action.hint.exit.fables_avatars:' + $newunique + '_head=Jump to Exit' | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
}
if ($rootfolder -eq "members" -or $rootfolder -eq "specials") {

    'entity.fables_avatars:' + $newunique + '_avatar.name=' + $Display_Name +"'" + 's Avatar' | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
    'entity.fables_avatars:' + $newunique + '_head.name=' + $Display_Name +"'" + 's Head' | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
    'item.fables_avatars:' + $newunique + '_avatar_item=' + $Display_Name +"'" + 's  Avatar' | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
    'item.fables_avatars:' + $newunique + '_head_item=' + $Display_Name +"'" + 's  Head' | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
    'item.fables_avatars:' + $newunique + '_mask=' + $isWearable + $Display_Name +"'" + 's  Mask' | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append

}

#or Wearables
if ($rootfolder -eq "wearables") {
    'item.fables_avatars:' + $newunique + '_mask=[FoF] ' + $Display_Name | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
}

#or Uniques
if ($rootfolder -eq "uniques") {
    'item.fables_avatars:' + $newunique + '_item=[FoF] ' + $Display_Name | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
    'entity.fables_avatars:' + $newunique + '.name=' + $Display_Name  | out-file -Encoding ASCII $ScriptPath\$RPFolder\texts\en_US.lang -Append
}
