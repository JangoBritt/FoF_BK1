...
import { directions, solidBlocks, blockException } from '../util/globalVariables6';
import { MfSimpleRotation, MfSitOffset1, MfSitCenter, MfSetOldDirection2 } from './Util6';
...
world.beforeEvents.worldInitialize.subscribe((e) => {
	e.blockComponentRegistry.registerCustomComponent("mf6:old_rotation2", new MfSetOldDirection2());
