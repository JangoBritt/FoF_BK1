execute @e[type=item,name="copper ingot"] ~~~ detect ~~~ lightning_rod -1 execute @s ~~~ detect ~~-1~ copper_block -1 summon fables_golem:copper_golem ~ ~ ~ ~ ~ minecraft:entity_spawned
