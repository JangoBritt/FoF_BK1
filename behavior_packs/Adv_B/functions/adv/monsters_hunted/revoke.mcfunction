...
tag @s remove Killed_WitherSkeleton
tag @s remove Killed_Zoglin
tag @s remove Killed_Zombie
tag @s remove Killed_ZombieVillager
tag @s remove Killed_ZombifiedPiglin
tag @s remove Killed_Bogged
tag @s remove Killed_Breeze