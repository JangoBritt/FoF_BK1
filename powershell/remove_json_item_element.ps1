...
#Full Folder Path to BP/Items folder
  $blockspath = "C:\Users\adam\AppData\Local\Packages\Microsoft.MinecraftUWP_8wekyb3d8bbwe\LocalState\games\com.mojang\minecraftWorlds\ACS6_V1.0\behavior_packs\MFV6.3_BP\items\”
...
foreach ($filename in $jsonlist) {
    ...
    $removeStaging.'minecraft:item' = $removeStaging.'minecraft:item' | Select-Object * -ExcludeProperty events
